///////////////////////////////////////////////////////////////////////////
// Description: Data Access class for the view 'V_DM_GIANG_VIEN'
// Generated by LLBLGen v1.21.2003.712 Final on: Wednesday, September 21, 2011, 3:16:42 PM
...
{
	/// <summary>
	/// Purpose: Data Access class for the view 'V_DM_GIANG_VIEN'.
	/// </summary>
	public class V_DM_GIANG_VIEN : DBInteractionBase
	{
		#region Class Member Declarations
			private SqlDateTime		_nGAY_CAP, _nGAY_SINH;
			private SqlDecimal		_iD, _iD_DON_VI_QUAN_LY;
			private SqlString		_tRANG_THAI_GIANG_VIEN, _nOI_CAP, _iD_TRANG_THAI_GIANG_VIEN, _sO_TAI_KHOAN, _tEN_NGAN_HANG, _sO_CMTND, _dON_VI_QUAN_LY, _gV_THAM_DINH_HL_YN, _gV_DUYET_HL_YN, _dESCRIPTION, _gV_HDKH_YN, _gVHD_YN, _mA_SO_THUE, _gV_VIET_HL_YN, _gVCM_YN, _cHUC_VU_CAO_NHAT, _cHUC_VU_HIEN_TAI, _tEL_OFFICE, _tEL_HOME, _hO_VA_TEN_DEM, _mA_GIANG_VIEN, _gIOI_TINH_YN, _tEN_GIANG_VIEN, _mOBILE_PHONE, _hOC_HAM, _hOC_VI, _tRUONG_DAO_TAO, _cHUYEN_NGANH_CHINH, _tEN_CO_QUAN_CONG_TAC, _eMAIL, _aNH_CA_NHAN, _eMAIL_TOPICA;
		#endregion
		...
		///		 <LI>TRANG_THAI_GIANG_VIEN. May be SqlString.Null</LI>
		...
		public override bool Insert()
		{
			...
			cmdToExecute.CommandText = "dbo.[pr_V_DM_GIANG_VIEN_Insert]";
			...
			try
			{
				...
				cmdToExecute.Parameters.Add(new SqlParameter("@sTRANG_THAI_GIANG_VIEN", SqlDbType.NVarChar, 250, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, _tRANG_THAI_GIANG_VIEN));
				...
				cmdToExecute.Parameters.Add(new SqlParameter("@sDON_VI_QUAN_LY", SqlDbType.NVarChar, 250, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, _dON_VI_QUAN_LY));
			...
			catch(Exception ex)
			{
				...
				throw new Exception("V_DM_GIANG_VIEN::Insert::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		public SqlString TRANG_THAI_GIANG_VIEN
		{
			get
			{
				return _tRANG_THAI_GIANG_VIEN;
			}
			set
			{
				SqlString tRANG_THAI_GIANG_VIENTmp = (SqlString)value;
				if(tRANG_THAI_GIANG_VIENTmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("TRANG_THAI_GIANG_VIEN", "TRANG_THAI_GIANG_VIEN can't be NULL");
				}
				_tRANG_THAI_GIANG_VIEN = value;
			}
		}
