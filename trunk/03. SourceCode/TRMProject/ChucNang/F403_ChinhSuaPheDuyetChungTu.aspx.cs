...
public partial class ChucNang_F403_ChinhSuaPheDuyetChungTu : System.Web.UI.Page
{
    ...
    private void load_data_2_grid(string ip_str_ma_dot_tt)
    {
        ...
        else
        {
            ...
            v_us_gd_thanh_toan.f501_load_thanh_toan_by_ma_dot_tt_va_trang_thai_tt(ip_str_ma_dot_tt, CIPConvert.ToDecimal(lblUser.ToolTip), m_v_ds_gd_thanh_toan, CIPConvert.ToStr(Session["UserName"]));
    ...
    private void load_data_2_grid_search(string ip_str_ma_dot_tt, string ip_str_so_hd)
    {
        US_V_GD_THANH_TOAN v_us_gd_thanh_toan = new US_V_GD_THANH_TOAN();
        DS_V_GD_THANH_TOAN v_ds_gd_thanh_toan = new DS_V_GD_THANH_TOAN();
        v_us_gd_thanh_toan.f403_load_thanh_toan_by_ma_dot_tt_va_trang_thai_tt_va_like_so_hd(ip_str_ma_dot_tt, CIPConvert.ToDecimal(lblUser.ToolTip), ip_str_so_hd, m_v_ds_gd_thanh_toan, CIPConvert.ToStr(Session["UserName"]));
