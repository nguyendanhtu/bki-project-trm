<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="F106_HoSo.aspx.cs" Inherits="DanhMuc_F106_HoSo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <table cellspacing="0" cellpadding="2" style="width: 100%;" class="cssTable" border="0">
        ...
        <tr>
            <td class="cssPageTitleBG" colspan="3">
                <asp:Label ID="Label11" runat="server" CssClass="cssPageTitle" Text="Kết quả lọc dữ liệu" />
            </td>
        </tr>
        <tr>
            <td align="left">
        ...
        <tr>
            ...
            <td>
                <ew:CalendarPopup ID="m_dat_ngay_bat_dau_tu" runat="server" ControlDisplay="TextBoxImage"
                    ...
                    ShowGoToToday="True" Width="100px" SelectedDate="" Text="" Culture="vi-VN" DisableTextboxEntry="False">
