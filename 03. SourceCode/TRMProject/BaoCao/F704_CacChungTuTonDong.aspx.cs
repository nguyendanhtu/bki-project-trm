...
public partial class BaoCao_F704_CacChungTuTonDong : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            load_data_2_po_phu_trach();
            if (m_cbo_po_lap_bang_ke.Items.Count > 0)
            {
                m_cmd_tim_kiem.Enabled = true;
               // fill_data_2_thong_tin_dot_tt(CIPConvert.ToDecimal(m_cbo_po_lap_bang_ke.SelectedValue));
            }
            else
            {
    ...
    private void load_data_2_excel_search(decimal ip_dc_thang_tt, decimal ip_dc_nam_tt)
    {
        string v_str_po_phu_trach = "";
        //if (ip_dc_id_dot_tt == 0) v_str_ma_dot_tt = "All";
        v_str_po_phu_trach = get_ten_truy_nhap_by_id(CIPConvert.ToDecimal(m_cbo_po_lap_bang_ke.SelectedValue));
    ...
    {
        load_data_2_excel_search(CIPConvert.ToDecimal(m_cbo_thang_thanh_toan.SelectedValue), CIPConvert.ToDecimal(m_cbo_nam_thanh_toan.SelectedValue));
        ...
        strTable += "\n<td><align='center' class='cssTableView' style='width:100%;' nowrap='nowrap'>  </td>";
        strTable += "\n<td><align='center' class='cssTableView' style='width:100%;' nowrap='nowrap'>  </td>";
        strTable += "\n<td><align='center' class='cssTableView' style='width:100%;' nowrap='nowrap'>PO lập bảng kê: " + m_cbo_po_lap_bang_ke.SelectedItem.Text + "</td>";
        strTable += "\n</tr>";
        //
        strTable += "\n<tr>";
        strTable += "\n<td><align='center' class='cssTableView' style='width:100%;' nowrap='nowrap'>  </td>";
        ...
        strTable += "\n<td><align='center' class='cssTableView' style='width:100%;' nowrap='nowrap'>  </td>";
        strTable += "\n<td><align='center' class='cssTableView' style='width:100%;' nowrap='nowrap'>  </td>";
        strTable += "\n<td><align='center' class='cssTableView' style='width:100%;' nowrap='nowrap'>Tháng thanh toán : " + m_cbo_thang_thanh_toan.SelectedItem.Text + "</td>";
        strTable += "\n</tr>";
        //
        strTable += "\n<tr>";
        strTable += "\n<td><align='center' class='cssTableView' style='width:100%;' nowrap='nowrap'>  </td>";
        strTable += "\n<td><align='center' class='cssTableView' style='width:100%;' nowrap='nowrap'>  </td>";
        strTable += "\n<td><align='center' class='cssTableView' style='width:100%;' nowrap='nowrap'>Năm thanh toán : " + m_cbo_nam_thanh_toan.SelectedItem.Text + "</td>";
        strTable += "\n</tr>";
        strTable += "\n</table>";
        //table noi dung
        strTable += "<table cellpadding='2' cellspacing='0' class='cssTableReport'>";
    ...
    protected void m_cmd_tim_kiem_Click(object sender, EventArgs e)
    {
        try
        {
            load_data_2_grid_search(CIPConvert.ToDecimal(m_cbo_thang_thanh_toan.SelectedValue), CIPConvert.ToDecimal(m_cbo_nam_thanh_toan.SelectedValue));
        }
        catch (Exception v_e)
        {
    ...
    protected void m_cbo_po_lap_bang_ke_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            load_data_2_grid_search(CIPConvert.ToDecimal(m_cbo_thang_thanh_toan.SelectedValue), CIPConvert.ToDecimal(m_cbo_nam_thanh_toan.SelectedValue));
