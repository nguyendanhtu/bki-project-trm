...
public partial class BaoCao_F703_LichSuThanhToanHopDong : System.Web.UI.Page
{
    ...
    private void load_data_2_grid_search(string ip_str_loai_hop_dong,string ip_str_so_hd)
    {
        ...
        m_us_v_gd_thanh_toan.fill_dataset_by_so_hop_dong(ip_str_loai_hop_dong, ip_str_so_hd, m_v_ds_gd_thanh_toan, CIPConvert.ToStr(Session["UserName"]));
    ...
    private void search_data_show_on_grid(string ip_str_so_hop_dong)
    {
        ...
        load_data_2_grid_search(v_str_loai_hd,ip_str_so_hop_dong);
    }
    ...
    {
        load_data_2_excel_search(m_txt_so_hop_dong.Text.Trim());
        ...
        strTable += "\n<td><align='center' class='cssTableView' style='width:100%;' nowrap='nowrap'>  </td>";
        strTable += "\n<td><align='center' class='cssTableView' style='width:100%;' nowrap='nowrap'>  </td>";
        strTable += "\n<td><align='center' class='cssTableView' style='width:100%;' nowrap='nowrap'>Số hợp đồng: " + m_txt_so_hop_dong.Text + "</td>";
        strTable += "\n</tr>";
        //
        strTable += "\n<tr>";
        strTable += "\n<td><align='center' class='cssTableView' style='width:100%;' nowrap='nowrap'>  </td>";
    ...
    protected void m_cmd_tim_kiem_Click(object sender, EventArgs e)
    {
        try
        {
            search_data_show_on_grid(m_txt_so_hop_dong.Text.Trim());
        }
        catch (Exception v_e)
        {
    ...
    protected void m_cmd_xuat_excel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string strNamFile = "BaoCaoLichSuThanhToanTheoHopDong" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year + ".xls";
