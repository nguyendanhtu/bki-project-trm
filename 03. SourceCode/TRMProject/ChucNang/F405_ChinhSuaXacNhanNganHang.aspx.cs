...
public partial class ChucNang_F405_ChinhSuaXacNhanNganHang : System.Web.UI.Page
{
    ...
    private void load_data_2_grid(string ip_str_ma_dot_tt)
    {
        ...
        else
        {
            ...
            v_us_gd_thanh_toan.f501_load_thanh_toan_by_ma_dot_tt_va_trang_thai_tt(ip_str_ma_dot_tt, CIPConvert.ToDecimal(lblUser.ToolTip), v_ds_gd_thanh_toan);
    ...
    private void load_data_2_grid_search(string ip_str_ma_dot_tt, string ip_str_so_hd)
    {
        ...
        //    return;
        //}
        v_us_gd_thanh_toan.f403_load_thanh_toan_by_ma_dot_tt_va_trang_thai_tt_va_like_so_hd(ip_str_ma_dot_tt, CIPConvert.ToDecimal(lblUser.ToolTip), ip_str_so_hd, v_ds_gd_thanh_toan);
