...
public partial class ChucNang_F612_DuyetNghiemThuCongViec : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            load_data_2_cbo_noi_dung_tt_all();
            load_data_2_grv();
    ...
    private void load_data_2_cbo_noi_dung_tt_all()
    {
    ...
    private void loadTieuDe(ref string strTable)
    {
        ...
        //
        strTable += "\n<tr>";
        strTable += "\n<td colspan='6' align='center'><class='cssTableView' style='width: 100%;  height: 40px; font-size: large; color:White; background-color:#810C15;' nowrap='wrap'><span style='font-family:Times New Roman; font-weight:bold; font-size:1.4em;'>BẢNG CÔNG VIỆC GIẢNG VIÊN CHUYÊN MÔN ĐÃ DUYỆT NGHIỆM THU" + "</span></td>";
        strTable += "\n</tr>";
        ...
        strTable += "\n<td align='center' class='cssTableView' style='width:12%;' nowrap='nowrap'><span style='font-family:Times New Roman; font-weight:bold; font-size:1.1em'>Số lượng nghiệm thu</span></td>";
    ...
    protected void m_cmd_xuat_excel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string strNamFile = "BaoCaoCongViecnGVCMDaDuyetNghiemThu" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year + ".xls";
