...
public partial class ChucNang_F406_XacNhanToanBoGiangVien : System.Web.UI.Page
{
    ...
    private void load_data_2_dot_tt()
    {
        ...
        US_V_DM_DOT_THANH_TOAN v_us_dot_thanh_toan = new US_V_DM_DOT_THANH_TOAN();
        v_us_dot_thanh_toan.load_dot_thanh_toan_by_trang_thai(get_id_trang_thai_dot_tt_da_thanh_toan(),v_ds_dot_thanh_toan);
    ...
    #region Events
    protected void m_cmd_xac_nhan_tat_ca_giang_vien_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            m_us_dm_dot_thanh_toan.xac_nhan_toan_bo_giang_vien();
            string someScript;
